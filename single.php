        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <!-- Comment List -->
                    <div class="mb-5">
                        <h3 class="text-uppercase mb-4 cat-col" style="letter-spacing: 5px;">3 Comments</h3>
                        <div class="media mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <button class="btn btn-sm  all-btn">Reply</button>
                            </div>
                        </div>
                        <div class="media mb-4">
                            <img src="img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1"
                    ...
                    <div class="bg-secondary rounded p-5">
                        <h3 class="text-uppercase mb-4 cat-col" style="letter-spacing: 5px;">Leave a comment</h3>
                        <form>
                            ...
                            <div class="form-group mb-0">
                                <input type="submit" value="Leave Comment" class="btn  py-md-2 px-md-4 all-btn">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <!-- Recent Post -->
                    <div class="mb-5">
                        <h3 class="text-uppercase mb-4 cat-col" style="letter-spacing: 5px;">Recent Post</h3>
                        <a class="d-flex align-items-center text-decoration-none mb-3" href="">
                            <img class="img-fluid rounded" src="img/blog-80x80.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1 cat-col">Diam lorem dolore justo eirmod lorem dolore</h6>
                                <small class="sp-col">Jan 01, 2050</small>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none mb-3" href="">
                            <img class="img-fluid rounded" src="img/blog-80x80.jpg" alt="">
                    ...
                    <!-- Tag Cloud -->
                    <div class="mb-5">
                        <h3 class="text-uppercase mb-4 cat-col" style="letter-spacing: 5px;">Tag Cloud</h3>
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn  cloud-btn m-1">Design</a>
                            <a href="" class="btn cloud-btn m-1">Development</a>
                            <a href="" class="btn cloud-btn m-1">Marketing</a>
                            <a href="" class="btn cloud-btn m-1">SEO</a>
                            <a href="" class="btn cloud-btn m-1">Writing</a>
                            <a href="" class="btn cloud-btn m-1">Consulting</a>
                        </div>
                    </div>
                </div>
            </div>
